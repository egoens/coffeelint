...
(function() {
  ...
  LineLinter = (function() {
    ...
    LineLinter.prototype.checkTrailingWhitespace = function() {
      var line, str, token, tokens, _i, _len, _ref, _ref1, _ref2;
      if (regexes.trailingWhitespace.test(this.line)) {
        console.log((_ref = this.config['no_trailing_whitespace']) != null ? _ref.allowed_in_comments : void 0);
        if (!((_ref1 = this.config['no_trailing_whitespace']) != null ? _ref1.allowed_in_comments : void 0)) {
